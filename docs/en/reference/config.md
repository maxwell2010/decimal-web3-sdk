...
Systemcontracts; types, defaults and return value are specified below.
...
Devnet; types, defaults and return value are specified below.
...
Mainnet; types, defaults and return value are specified below.
...
Testnet; types, defaults and return value are specified below.
