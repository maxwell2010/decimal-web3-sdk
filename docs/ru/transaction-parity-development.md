...
Версия **0.1.2.dev0**, не опубликована. Релиз 0.1.1 не изменен.
...
Неопубликованный SDK теперь использует certifi для собственных REST/WSS-сессий;
...
Публичный SDK-релиз этим этапом не разрешается.
