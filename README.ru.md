...
**0.1.1 является кандидатом в релиз, а не заявлением о полном совпадении
с JS/Go SDK.** 55 высокоуровневых транзакционных методов проверяются офлайн.
Совместимость контрактов зависит от сети. [Покрытие и ограничения](docs/ru/status.md).
[Сравнение SDK](docs/ru/upstream-parity.md): JS 95 / Go 53 / Python 55 специализированных EVM-методов отправки, не процент полноты.
